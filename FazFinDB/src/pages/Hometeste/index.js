...
export default function Hometeste({ navigation, route }) {
      ...
      item.contaleite?.map((i) => {
        return (
          <View>
            ...
            <View>
              <Text>
                precoleite: {i.precoleite}, Litro de leite: {i.litros}{" "}
  ...
  return (
    <View style={{ flex: 1 }}>
      <TextInput onChangeText={setFazenda} placeholder="Nome da Fazenda" />
      <TextInput onChangeText={setDono} placeholder="Nome do proprietario" />
      <Button
        onPress={handleNewFazenda}
        color={"#f2f"}
      ...
      />
      <TouchableOpacity onPress={() => navigation.navigate("Leite")}>
        <Text>Teste</Text>
      </TouchableOpacity>
    </View>
  );
