...
import { AreaCont, Texto, Container, CampoTexto } from "./styles.js";
import {
  StyleSheet,
  View,
  TouchableOpacity,
          ...
          <AreaCont>
            <View style={styles.stiloModal}>
              ...
              <TouchableOpacity style={styles.botaoPress6}>
                <Text style={styles.tituloBotao}>{"Quantidade"}</Text>
                <CampoTexto placeholder=""></CampoTexto>
              </TouchableOpacity>
      ...
      >
        <Container>
          <AreaCont>
            ...
            <TouchableOpacity style={styles.botaoPress6}>
              <Text style={styles.tituloBotao}>{"Serviço prestado"}</Text>
              <CampoTexto placeholder=""></CampoTexto>
            </TouchableOpacity>

            <TouchableOpacity style={styles.botaoPress7}>
              <Text style={styles.tituloBotao}>{"Total Gasto"}</Text>
              <CampoTexto placeholder=""></CampoTexto>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.botaovoltar}
